...
\begin{document}
	...
	discussion on noise correlations \\
	discusson on synaptic connectivity \\
	discussion on differential correlations \\
	introduction to our results
	
	\section{Results}
	\subsection{Network Architecture}
	We consider the linear-nonlinear network architecture shown in Figure \ref{architecture}. 
	\begin{figure}[ht]
		\centering
		\scalebox{0.8}{
			\begin{tikzpicture}
