...
\begin{document}
	...
	\section{Results}
	We consider the network's coding ability after both the linear stage $(\boldsymbol{\ell})$ and the nonlinear stage $(\mathbf{r})$. We examine these measures in 
	\subsection{Structured Weights}
